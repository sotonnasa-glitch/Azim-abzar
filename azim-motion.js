(() => {
  ...
  style.textContent = `
    ...
    .az-motion-stage .ring:after{content:"";position:absolute;width:5px;height:5px;border-radius:50%;background:var(--gold2,#ffd84f);box-shadow:0 0 16px rgba(255,216,79,.8);left:12%;top:18%;animation:azDot 6s linear infinite;}
    ...
    .az-motion-stage .orbit:before{content:"";position:absolute;width:9px;height:9px;right:18%;top:3px;border-radius:50%;background:var(--gold2,#ffd84f);box-shadow:0 0 22px rgba(255,216,79,.9);}
    ...
    .az-motion-stage .spark{position:absolute;width:3px;height:3px;border-radius:50%;background:var(--gold2,#ffd84f);box-shadow:0 0 13px var(--gold,#f5b900);animation:azSpark 4s ease-in-out infinite;}
