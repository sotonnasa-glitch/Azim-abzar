(() => {
  ...
  function applyCustomerCopy() {
    ...
    if (meta) {
      meta.setAttribute('content', 'کاتالوگ جامع ابزارهای مکانیکی، کارگاهی و گاراژی با نمایش مشخصات، تصویر، سایزبندی و قیمت‌های ثبت‌شده؛ برای استعلام و سفارش با فروش در ارتباط باشید.');
    }
